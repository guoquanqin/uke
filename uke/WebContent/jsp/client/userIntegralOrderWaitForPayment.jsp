    ...
    <div class="container">
        ...
        <div class="rightsidebar">
            <div class="orderTop">
                ...
                <button id="comment" style="border-bottom: 2px solid red;color:red">待评价</button>
            </div>
            ...
            <div class="order">
                ...
                <div class="orderDetail">
                    <div class="orderGoods">
                        <a href="${pageContext.request.contextPath}/client/simpleGoods/goodsShopDetail.action?id=${goods.get(status.index).goodsId}"><img src="${pageContext.request.contextPath}/images/${goodsType.get(status.index).gtName }/${goods.get(status.index).goodsPicture}"></a>&emsp;&emsp;${goods.get(status.index).goodsName }
                    </div>
