...
<title>设置中心-修改地址</title>
<link rel="stylesheet" href="${pageContext.request.contextPath}/js/bootstrap/css/bootstrap.min.css" />
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/client/userSettingAddress.css"/>
...
<div class="content">
    <div class="container">
        ...
        <div class="rightsidebar">
            ...
            <div class="bottombar">
	            <div class="part2">
	                <div id="title">更改收货地址</div>
                    <div role="form" class="form form-inline">
                        <span><div>地址1</div><textarea class="form-control" size="50" v-model="address" name="userAddress"></textarea><font ref="address">为了能顺利送达，地址请务精确到街道门牌号</font></span>
                        <span><div>地址2</div><textarea class="form-control" size="50" v-model="address2" name="userAddress2" ></textarea></span>
                        <span><div>地址3</div><textarea size="50" class="form-control" v-model="address3" name="userAddress3" ></textarea></span>
                        <span><input type="submit" id="submit" @click="submit" class="btn btn-info" value="提交"/></span>
                    </div>
	            </div>
                <div class="part1">
                    <ul>
                        <li>个人信息<span class="edit"><a href=""><img src="${pageContext.request.contextPath}/images/icon/编辑.png"/>编辑</a></span></li>
                        ...
                        <li><div>注册时间</div>${i.registerTime }</li>
                    </ul>
                </div>
                <div class="part3">
                    <ul>
...
<script>
    ...
    var vm2=new Vue({
        ...
        data: {
            ...
            address2:'${i.userAddress2}',
            address3:'${i.userAddress3}'
        ...
        methods: {
            ...
            submit(e){
                var check=true;
                check=check&&this.checkIsNull(this.address,this.$refs.address,"默认地址不能为空");
                if(check){
                    alert("提交成功");
                    window.location.href="${pageContext.request.contextPath}/client/userCenter/userUpdateAddress.action?userAddress="+this.address+"&userAddress2="+this.address2+"&userAddress3="+this.address3;
                }
                else
                    e.preventDefault();
            },
