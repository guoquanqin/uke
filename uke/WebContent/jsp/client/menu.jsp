                ...
                <ul>
                   <c:forEach items="${snack }" var="i">
	                	...
	                	<li class="outerli">
	                        ...
	                        <img class="simple" src="${pageContext.request.contextPath}/images/优惠套餐/${i.goodsPicture}">
	                        <div class="explain">
	                            <span style="font-size:17px"><a href="${pageContext.request.contextPath}/client/simpleGoods/goodsDetail.action?id=${i.goodsId}">${i.goodsName }</a> </span>
	                            <span><font style="color:red;">￥<font style="font-size: 21px"> ${i.goodsPrice }</font></font>&emsp;
	                            <font style="text-decoration:line-through">￥ ${i.goodsPrice+2 }</font></span>
