...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/client/userIntegral.css"/>
    ...
    <div class="container">
        ...
        <div class="rightsidebar">
            ...
            <div class="rightContent">
                <h4>积分兑换</h4>
                <h5><a href="${pageContext.request.contextPath}/client/shop.action">查看更多 >></a></h5>
                <ul>
                	<c:forEach items="${shopList }" var="i" varStatus="status" begin="0" end="15">
	                    <li>
	                        <img src="${pageContext.request.contextPath}/images/${goodsType.get(status.index).gtName }/${goods.get(status.index).goodsPicture}">
	                        <span><p>${goods.get(status.index).goodsName }</p></span>
	                        <span></span>
	                        <span><p>兑换价 <font style="color:orangered;">${i.integral }</font> 积分 </p></span>
	                        <a href="${pageContext.request.contextPath}/client/integralPayment.action?shopId=${i.shopId}" class="btn">立即兑换</a>
	                    </li>
                    </c:forEach>
                </ul>
            </div>
