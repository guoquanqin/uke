    ...
    <div class="container">
        ...
        <div class="leftPart">
          <img src="${pageContext.request.contextPath}/images/${type }/${i.goodsPicture}">
            <div class="detail">
                <h4>${i.goodsName}</h4>
                <form action="${pageContext.request.contextPath}/client/integralPayment.action?shopId=${shopList.shopId}" method="post">
	                <div id="part1">
	                ...
	                <div id="part2">
	                    <span>所需积分：${shopList.integral }&emsp;&emsp;兑换数量：1<!-- <input type="number" min="1" name="number"  value="1"/> -->件</span>
	                    <c:if test="${i.goodsInventory!=0 }">
		                    <a id="buy" href="${pageContext.request.contextPath}/client/simpleGoods/goodsDetail.action?id=${i.goodsId}">购买商品</a>
		                    <input id="submit" type="submit" value="立即兑换" />
	                    </c:if>
	                    <c:if test="${i.goodsInventory==0 }">
		                    <a id="buy" href="javascript:return false;">已售罄</a>
