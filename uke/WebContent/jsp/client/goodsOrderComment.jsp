...
<div class="content">
    <div class="container">
        ...
        <div class="rightsidebar">
       		<div class="rightTop">
               <i><img src="${pageContext.request.contextPath}/images/icon/评价1.png"/></i>订单评价
            </div>
            <div class="rightContent">
                <div class="order">
                    ...
                    <div class="orderDetail">
                    	<c:forEach items="${orderGoodsList }" var="i" varStatus="status">
	                        <div class="goods">
	                            <label><a href="${pageContext.request.contextPath}/client/simpleGoods/goodsDetail.action?id=${i.goodsId}"><img src="${pageContext.request.contextPath}/images/${goodsTypeList.get(status.index).gtName }/${goodsList.get(status.index).goodsPicture}"></a>${goodsList.get(status.index).goodsName }</label>
	                            <label>￥${i.goodsTotalPrice/i.goodsCount }</label>
	                            <label>${i.goodsCount }</label>
	                            <label>
	                            	<c:if test="${status.index==0 }">
	                            		${orderUser.orderPrice }
	                            	</c:if>
                ...
                <form action="${pageContext.request.contextPath}/client/saveGoodsOrderComment.action?orderUser=${orderUser.orderUserId}" method="post" enctype="multipart/form-data">
                <div class="comment">
                    <label>质量与服务</label>
