    ...
    <div class="container">
        ...
        <div class="rightsidebar">
            <div class="orderTop">
                ...
                <form role="form"  class="input-group" action="${pageContext.request.contextPath}/client/userCenter/userOrderBySearch.action?pageNum=1" method="post">
                    <input type="text" size="18" class="form-control" name="search" placeholder="按商品关键字或订单号搜索订单"/>
	                    ...
	                    <div class="orderStatus">
	                         ...
	                         <c:choose>
	                         	...
	                         	<c:when test="${i.orderStatus==5 }">
	                         		...
	                         		<a href="${pageContext.request.contextPath}/client/goodsOrderComment.action?orderUserId=${i.orderUserId}" style="color:red;">去评价</a>
	                         	</c:when>
