...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/management/goodsSet2.css"/>
    ...
    <div class="mainContent">
        <div class="content">
            <div class="contentleft">
                ...
                <form role="form" class="form-inline" action="${pageContext.request.contextPath}/management/saveGoodsSetting.action" method="post" enctype="multipart/form-data">
                    <input type="hidden" value="${goods.goodsId }" name="id"/>
                    <label>
                        <span><font style="color: red;">*</font>商品名称</span>
                        <input type="text" id="name" name="goodsName" class="form-control" value="${goods.goodsName }"/>
                        <c:if test="${mess!=null }">
                    ...
                    <label>
                        ...
                        <span>
                            ...
                            <img id="pic" src="${pageContext.request.contextPath}/images/${type.gtName }/${goods.goodsPicture}" />
                    ...
                    <label>
                        ...
                        <span>
                            <select id="size" class="form-control" name="size">
                            	<c:if test="${goods.goodsMiddlePrice==null }">
	                            	<option value="0" selected>无</option>
	                                <option value="1">大/中杯</option>
                            	</c:if>
                            	<c:if test="${goods.goodsMiddlePrice!=null }">
	                            	<option value="0">无</option>
	                                <option value="1" selected>大/中杯</option>
                            	</c:if>
                            </select>
                        </span>
                    </label>
                    <label >
                        ...
                        <c:if test="${goods.goodsMiddlePrice==null }">
	                        <span class="input-group" id="span2">
                            	<div><span class="input-group-addon">￥</span><input type="text" size="6px" name="price1" class="form-control" value="${goods.goodsPrice }"/></div>
                            	<input type="hidden" value="0" name="price2"/>
                        	</span>
                        	<span class="input-group" id="span1" style="display:none;">
	                            <div><font>大&emsp;&emsp;</font><span class="input-group-addon">￥</span><input type="text" name="price1" size="6px" class="form-control" value="${goods.goodsPrice }"/></div>
	                            <div><font>中&emsp;&emsp;</font><span class="input-group-addon">￥</span><input type="text" name="price2" size="6px" class="form-control" value="${goods.goodsMiddlePrice }"/></div>
                       		</span>
                        </c:if>
                        <c:if test="${goods.goodsMiddlePrice!=null }">
                        	<span class="input-group" id="span2" style="display:none;">
                            	<div><span class="input-group-addon">￥</span><input type="text" size="6px" name="price1" class="form-control" value="${goods.goodsPrice }"/></div>
                        		<input type="hidden" value="0" name="price2"/>
                        	</span>
	                        <span class="input-group" id="span1">
	                            <div><font>大&emsp;&emsp;</font><span class="input-group-addon">￥</span><input type="text" name="price1" size="6px" class="form-control" value="${goods.goodsPrice }"/></div>
	                            <div><font>中&emsp;&emsp;</font><span class="input-group-addon">￥</span><input type="text" name="price2" size="6px" class="form-control" value="${goods.goodsMiddlePrice }"/></div>
                       		</span>
                        </c:if>
                    ...
                    <label>
                        ...
                        <span>
                        	<c:if test="${goods.goodsDescribe==null }">
                            	<textarea cols="35" rows="3" name="describe" placeholder="介绍一下你的产品吧，50字以内就可以哦~"></textarea>
                            </c:if>
                        	<c:if test="${goods.goodsDescribe!=null }">
                            	<textarea cols="35" rows="3" name="describe">${goods.goodsDescribe }</textarea>
                            </c:if>
                        </span>
                    </label>
                    <label>
         ...
         $("#submit").click(function (e) {
             ...
             if(name>10){
            	...
            	var con=confirm("确定提交吗？");
     			if(con==true){
     				alert("提交成功")
     				window.location.href="${pageContext.request.contextPath}/management/saveGoodsSetting.action";
     			}else{
     				 e.preventDefault();
     			}
             }
