...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/management/forgetPass1.css"/>
    ...
    <div id="content" class="container">
        <div class="panel">
            ...
            <div class="panel-body">
                <form role="form" class="form form-inline" action="${pageContext.request.contextPath }/management/checkCode.action" method="post">
        ...
        var vm=new Vue({
            ...
            methods:{
                ...
                submit(e){
                    ...
                    if(check){
                        window.location.href="${pageContext.request.contextPath }/management/checkCode.action";
                    }
                    else
                        e.preventDefault();
                },
