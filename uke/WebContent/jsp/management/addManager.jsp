    ...
    <div class="mainContent">
        <div class="content">
            <div class="contentleft">
                ...
                <form class="form-inline" action="${pageContext.request.contextPath}/management/addManager.action" method="post">
                    <label>
                        真实姓名<input id="name" name="managerName" type="text" class="form-control" required/>
                        <font id="mess1">请输入2位以上有效字符</font>
                    </label>
                    <label>
                    ...
                    <label>
                        设置密码<input type="password" id="password" name="managerPassword" class="form-control" required />
                        <font id="mess4">请输入8到16位有效字符</font>
                    </label>
                    <label>
                        重复密码<input type="password" id="confirmPass" class="form-control" required/>
                        <font id="mess5"></font>
                    </label>
        ...
        <div class="contentright">
                ...
                <div class="rightpart2">
                    <a href="${pageContext.request.contextPath}/jsp/management/addManager.jsp"><img src="${pageContext.request.contextPath}/images/icon/刷新.png" title="刷新数据"></a>
                    <h4>统计</h4>
                    <div>
                        <p>今日订单数：
                        	<c:choose>
